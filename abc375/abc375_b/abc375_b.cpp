...
int main() {
    ...
    double x = 0.0, y = 0.0;
    totalCost += euclideanDistance(x, y, points[0].first, points[0].second);
    for (int i = 0; i < N - 1; ++i) totalCost += euclideanDistance(points[i].first, points[i].second, points[i + 1].first, points[i + 1].second);
